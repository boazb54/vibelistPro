...
// CogIcon is removed from App.tsx but kept here if other components use it
...
export const MicIcon: React.FC<{className?: string; onClick?: () => void}> = ({className, onClick}) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} onClick={onClick}>
...
export const BurgerIcon: React.FC<{className?: string; onClick?: () => void}> = ({className, onClick}) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} onClick={onClick}>
