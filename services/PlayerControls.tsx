...
const PlayerControls: React.FC<PlayerControlsProps> = ({
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 p-4 z-50 animate-slide-up">
      ...
      <div className="max-w-4xl mx-auto bg-slate-900/80 backdrop-blur-xl rounded-2xl p-4 flex items-center gap-4 shadow-2xl border-t border-white/10 relative">
        ...
        <div className="flex items-center gap-2 md:gap-4">
          ...
          <button 
            ...
            className="w-12 h-12 flex items-center justify-center rounded-full bg-white text-black hover:scale-105 active:scale-95 transition-all shadow-lg shadow-white/20"
          >
